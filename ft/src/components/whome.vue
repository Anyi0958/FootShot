...
<div style="background:#f7f7f7;"> 
    ...
    <div class="content py-4" style="width: 100%;padding: 0 5%;">
        <div class="row">
            <div class="col-lg-3 col-sm-6 col-12 p-4" v-for="(elem,i) of album" :key="i"> 
...
export default {
    ...
    mounted(){
        ...
        $('body').click(e=>{console.log($(e.target))})
        $('#nav_ul').css('flex-direction','row')
        $('#banner').css('display','none')
        $('.look').click((e)=>{
            console.log($(e.target).attr('data-album'))
